...
use Root\api\components\settings\Settings as SettingsAlias;
use Smarty;
...
class Design
{
    ...
    private SettingsAlias $settings;
    ...
    public function __construct()
    {
        ...
        $this->filesystem = Simpla::$container->filesystem;
        ...
        if (!$this->filesystem->exists($this->smarty->compile_dir)) {
            $this->filesystem->mkdir($this->smarty->compile_dir, 0777);
        }
